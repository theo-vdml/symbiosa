<div class="bg-white border border-gray-100 rounded-xl p-4 max-w-125 shadow-sm font-sans text-left">
    <div class="flex items-start gap-3 mb-3">
        <img src="https://api.dicebear.com/9.x/dylan/svg?seed=aefeteg"
