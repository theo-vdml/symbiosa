        ...
        >
            <section class="mb-14 space-y-4 text-center md:text-left">
                ...
                <div class="space-y-2.5 pt-1">
                    <div class="flex flex-wrap items-center gap-1.5">
                        <span
                            class="mr-1 text-[10px] font-bold tracking-[0.2em] text-gray-500 uppercase"
                            >Type</span
                        >
                        <button
                            type="button"
            ...
            >
                <Link
                    ...
                    :key="event.id"
                    :href="event.infoLink"
                    class="group overflow-hidden rounded-2xl border border-white/10 bg-white/3 transition-all duration-300 hover:-translate-y-0.5 hover:border-white/20 focus-visible:ring-2 focus-visible:ring-[#c80a45] focus-visible:outline-none"
                >
                    <div class="relative aspect-3/4 overflow-hidden">
                        ...
                        >
                            <p
                                class="font-chillax text-4xl leading-none text-white"
                            >
                                {{ getDateParts(event.isoDate).day }}
                            </p>
                            <p
                                class="text-[10px] font-bold tracking-[0.2em] text-gray-200 uppercase"
                            >
                    ...
                    <div class="space-y-3.5 p-5">
                        <div class="flex flex-wrap gap-2">
                            <span
                                class="rounded-full border border-[#c80a45]/40 bg-[#c80a45]/15 px-3 py-1 text-[10px] font-bold tracking-[0.18em] text-white uppercase"
                            >
                                {{ event.type }}
                            </span>
                            <span
                        ...
                        <h2
                            class="font-chillax text-[1.9rem] leading-none text-white md:text-[2.1rem]"
                        >
                            {{ event.title }}
                        </h2>
