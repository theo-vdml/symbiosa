        ...
        <div class="relative h-screen w-full overflow-hidden">
            ...
            <div class="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center">
                <div class="overflow-hidden py-2">
                    <span class="block font-synonym text-xs md:text-sm tracking-[0.5em] text-white/70 uppercase mb-4 animate-fade-in-up opacity-0">
                        DJ Sets & Expériences
                    </span>
                </div>
                
                <div class="overflow-hidden py-10 -my-10">
                    <h1 class="font-chillax text-[clamp(4rem,18vw,14rem)] leading-[0.85] text-white tracking-tighter animate-reveal-title opacity-0">
                        Symbiosa
                    </h1>
                </div>

                <div class="overflow-hidden py-2">
                    <span class="block font-synonym text-xs md:text-sm tracking-[0.3em] text-white/50 uppercase mt-6 animate-fade-in-up [animation-delay:800ms] opacity-0">
                        Belgique — Est. 2026
                    </span>
                </div>
            </div>
            ...
            <!-- Scroll Indicator -->
            <div class="absolute bottom-12 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-4 animate-fade-in [animation-delay:1500ms] opacity-0">
