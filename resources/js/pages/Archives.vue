...
<template>
    ...
    <div
        class="relative z-10 min-h-[120vh] overflow-hidden rounded-b-[6rem] bg-black"
    >
        <div
        ...
        >
            <section class="mb-8 space-y-3 text-center md:text-left">
                <p
                    class="text-xs font-bold tracking-[0.35em] text-[#c80a45] uppercase"
                >
                    Archives
                </p>
                <h1
                    class="font-chillax text-5xl leading-[0.92] text-white md:text-7xl lg:text-8xl"
                >
                    Les souvenirs de Symbiosa
                </h1>
                <p
                    class="max-w-2xl font-synonym text-sm text-gray-300 md:text-base"
                >
                ...
                <div class="max-w-xl pt-2">
                    <input
                        ...
                        class="w-full rounded-full border border-white/15 bg-white/5 px-5 py-3 text-sm text-white placeholder:text-gray-500 focus:border-[#c80a45]/70 focus:ring-2 focus:ring-[#c80a45]/30 focus:outline-none"
                    />
                </div>
            </section>
            ...
            <section v-if="eventsByYear.length" class="space-y-7">
                ...
                >
                    <div class="md:pt-1.5">
                        <p
                            class="font-chillax text-3xl leading-none text-white/90 md:text-4xl"
                        >
                            {{ group.year }}
                        </p>
                    </div>
                        ...
                        >
                            <div class="min-w-0 space-y-2.5">
                                ...
                                >
                                    ...
                                    <span
                                        class="rounded-full border border-[#c80a45]/40 bg-[#c80a45]/15 px-2 py-0.5 text-[9px] font-bold tracking-[0.12em] text-white uppercase"
                                    >
                                        {{ event.type }}
                                    </span>
                                </div>
                                ...
                                <h2
                                    class="font-chillax text-2xl leading-none text-white md:text-[1.85rem]"
                                >
                                    {{ event.title }}
                                </h2>
                                ...
                                >
                                    ...
                                    <p
                                        class="ml-auto text-[10px] font-bold tracking-[0.14em] text-[#c80a45] uppercase"
                                    >
                                        Voir recap
                                    </p>
                                </div>
