...
<template>
    <nav
        ...
        <button
            ...
            class="group pointer-events-auto flex flex-col gap-1.5 md:hidden focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50 rounded-sm p-2 relative z-50"
